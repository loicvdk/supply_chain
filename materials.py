...
class Grade(Material):
    ...
    def __init__(self, name, production_rate, variable_costs, raw_material, raw_material_needed, inventory):
        super().__init__(name, production_rate, variable_costs, inventory)
...
########## OBJECTS CREATION ##########
######################################
typeA = Material('type A', 75, 1.48, [2513, 0, 0, 0, 0])
typeB = Material('type B', 62, 1.62, [0, 5973, 0, 0, 0])
