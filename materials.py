...
class Material:
    ...
    def __init__(self, name, production_rate, variable_costs):
        self.name = name
...
########## OBJECTS CREATION ##########
######################################
typeA = Material('type A', 75, 1.48)
typeB = Material('type B', 62, 1.62)

grade1 = Grade('grade 1', 91, 1.63, typeA, 0.9)
grade2 = Grade('grade 2', 76, 1.69, typeA, 0.9)
grade3 = Grade('grade 3', 83, 1.74, typeB, 0.9)
