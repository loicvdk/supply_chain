...
class Stage:
    ...
    def __init__(self, production, storage, lost_capacity):
...
#--- Stages ---#
stage1 = Stage((typeA, typeB), (silo1_stage1, silo2_stage1, silo3_stage1), 8)
stage2 = Stage((grade1, grade2, grade3), (tank1_stage2, tank2_stage2,
                                          tank3_stage2, tank4_stage2, tank5_stage2, tank6_stage2),  20)
